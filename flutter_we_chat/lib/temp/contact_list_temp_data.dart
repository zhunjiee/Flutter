/**
 * @ClassName contact_list_temp_data
 * @Description TODO
 * @Author Houge
 * @Date 2020/3/20 2:45 PM
 * @Version 1.0
 */
...
class ContactListTempData {
  static List<ContactModel> mock() {
    return [
      ContactModel(type: 1, url: null, name: "Flower", startLetter: "F"),
      ContactModel(
          type: 1,
          url:
      ...
      ContactModel(
          ...
          name: "JJ",
          startLetter: "J"),
      ContactModel(type: 1, url: null, name: "biao", startLetter: "B"),
      ContactModel(
          type: 1,
          url:
          ...
          name: "移动端",
          startLetter: "Y"),
      ContactModel(type: 1, url: null, name: "Cling", startLetter: "C"),
      ContactModel(
          type: 1,
          url:
      ...
      ContactModel(
          ...
          name: "James",
          startLetter: "J"),
      ContactModel(type: 1, url: null, name: "...", startLetter: "#"),
      ContactModel(type: 1, url: null, name: "齐天大圣", startLetter: "Q"),
      ContactModel(
          type: 1,
          url:
      ...
      ContactModel(
          ...
          name: "Age",
          startLetter: "A"),
      ContactModel(type: 1, url: null, name: "花果山", startLetter: "H"),
      ContactModel(
          type: 1,
          url:

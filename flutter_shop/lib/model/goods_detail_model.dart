...
class DetailModel {
  ...
  AdvertPicture advertPicture;

  DetailModel({this.goodInfo, this.goodComments, this.advertPicture});
  ...
  DetailModel.fromJson(Map<String, dynamic> json) {
    ...
    advertPicture = json['advertesPicture'] != null
        ? new AdvertPicture.fromJson(json['advertesPicture'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.advertPicture != null) {
      data['advertesPicture'] = this.advertPicture.toJson();
    }
    return data;
  }
}
...
class AdvertPicture {
  ...
  AdvertPicture({this.pictureAddress, this.toPlace});

  AdvertPicture.fromJson(Map<String, dynamic> json) {

...
import 'package:route_test/arguments_route.dart';
import 'package:route_test/tip_route.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "arguments_route" : (context) => ArgumentsRoute(),
      },
      initialRoute: "/",
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () {
                ...
                // 导航到新路由
//                Navigator.of(context).pushNamed("arguments_route", arguments: "这是从前一页传过来的参数: hi hi hi");
